...
\end{verbatim}
  ...
  \item
    ...
    The accuracy for each setting is:
      ...
      Classification accuracy: 14.70\% for classification with $d=10$.

      Classification accuracy: 10.80\% for classification with $d=25$.
      
      Classification accuracy: 10.90\% for classification with $d=50$.
      
      Classification accuracy: 10.50\% for classification with $d=100$.
